...
# ANSI Colours
RESET = "\033[0m"; BOLD = "\033[1m"; RED = "\033[91m"; YELLOW = "\033[93m"; GREEN = "\033[92m"
CYAN = "\033[96m"; MINT = "\033[38;5;121m"; GREY = "\033[90m"; WHITE = "\033[97m"; DIM = "\033[2m"
...
def main():
    ...
    while True:
        ...
        if user_input.lower() in ("exit", "quit", "q"):
            # Restore bar cursor on clean exit
            sys.stdout.write(CURSOR_BAR)
            sys.stdout.flush()
            print(colour("\n  Goodbye.\n", GREY))
            sys.exit(0)
